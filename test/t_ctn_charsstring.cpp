...
namespace TEST
{
	extern GAIA::GVOID t_ctn_charsstring(GAIA::LOG::Log& logobj)
	{
		...
		GAIA::CTN::ACharsString strUtf8 = str.toUtf8();
		GAIA::CTN::WCharsString strWString = strUtf8.toWString(GAIA::CHARSET_TYPE_UTF8);
		if(strWString != str)
			TERROR;

		GAIA::CTN::WCharsString strLocale(_T("Hello World, 测试utf8字符串！"));
		GAIA::CTN::ACharsString strLocale1(strLocale.fptr(), "UTF-8");
		GAIA::CTN::WCharsString strLocale2(strLocale1.fptr(), "UTF-8");
