...
namespace GAIA
{
	namespace MATH
	{
		...
		public:
			...
			template<typename _ParamDataType> MTX43(const _ParamDataType& v){this->operator = (v);}
			...
			GINL GAIA::BL isalmostidentity() const
			{
				if(	GAIA::MATH::gequal(m[0][0], (_DataType)1) && GAIA::MATH::gequal(m[0][1], (_DataType)0) && GAIA::MATH::gequal(m[0][2], (_DataType)0) &&
					...
					GAIA::MATH::gequal(m[3][0], (_DataType)0) && GAIA::MATH::gequal(m[3][1], (_DataType)0) && GAIA::MATH::gequal(m[3][2], (_DataType)0))
					return GAIA::True;
				return GAIA::False;
			}
			GINL GAIA::BL isalmostidentity(const _DataType& epsilon) const
			{
				if(	GAIA::MATH::gequal(m[0][0], (_DataType)1, epsilon) && GAIA::MATH::gequal(m[0][1], (_DataType)0, epsilon) && GAIA::MATH::gequal(m[0][2], (_DataType)0, epsilon) &&
					...
					GAIA::MATH::gequal(m[3][0], (_DataType)0, epsilon) && GAIA::MATH::gequal(m[3][1], (_DataType)0, epsilon) && GAIA::MATH::gequal(m[3][2], (_DataType)0, epsilon))
					return GAIA::True;
				return GAIA::False;
			}
			...
			template<typename _ParamDataType> GAIA::BL operator == (const GAIA::MATH::MTX43<_ParamDataType>& src) const{return GAIA::ALGO::cmps(this->fptr(), src.fptr(), this->size()) == 0;}
			...
			template<typename _ParamDataType1, typename _ParamDataType2> _DataType& operator () (const _ParamDataType1& i1, const _ParamDataType2& i2){GAST(i1 >= 0 && i1 < 4); GAST(i2 >= 0 && i2 < 3); return m[i1][i2];}
		public:
			_DataType m[4][3];
		};
	}
