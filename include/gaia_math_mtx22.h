...
namespace GAIA
{
	namespace MATH
	{
		...
		public:
			...
			template<typename _ParamDataType> MTX22(const _ParamDataType& v){this->operator = (v);}
			...
			template<typename _ParamDataType> GAIA::BL operator == (const GAIA::MATH::MTX22<_ParamDataType>& src) const{return GAIA::ALGO::cmps(this->fptr(), src.fptr(), this->size()) == 0;}
