#ifndef		__GAIA_SYNC_LOCKPURE_H__
#define		__GAIA_SYNC_LOCKPURE_H__
...
namespace GAIA
{
	...
	{
		/*!
			@brief Sync no-recursive lock.
		*/
		class LockPure : public GAIA::Base
		{
		public:
			GINL LockPure()
			{
		...
		private:
			GINL LockPure(const LockPure& src){}
		private:
		#if GAIA_OS == GAIA_OS_WINDOWS
